...
def build_context_block(context: RetrievedContext, max_characters: int) -> str:
    ...
    for candidate in context.candidates:
        snippet = f"[Doc {candidate.rank}] PMID={candidate.document_id}\nTitle: {candidate.title}\n{candidate.text}\n"
...
def build_prompt(question: QuestionRecord, context: RetrievedContext, config: ProjectConfig) -> str:
    ...
    instruction = {
        ...
        "list": "Return a concise list of answers, one item per line. If unsupported, say I don't know.",
        "summary": "Write a concise grounded summary. If the evidence is insufficient, say I don't know.",
